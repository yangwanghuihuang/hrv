    ...
    <Modal v-model="modal2" width="500" @on-cancel="cancel">
      ...
      <div style="text-align:left">
        <Form ref="formValidate" label-position="right" :label-width="100">
          <FormItem label="结算周期名称：">
            <Input disabled v-model="formValidate.id" placeholder="Enter your name"></Input>
          </FormItem>
          ...
          <FormItem label="开始日期：">
            <Input disabled v-model="formValidate.config" placeholder="Enter your name"></Input>
          </FormItem>
          <FormItem label="结束日期：">
            <Input disabled v-model="formValidate.config" placeholder="Enter your name"></Input>
          </FormItem>
